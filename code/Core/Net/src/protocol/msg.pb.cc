...
// optional fixed32 checksum = 4;
bool MsgHead::has_checksum() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
void MsgHead::set_has_checksum() {
  _has_bits_[0] |= 0x00000008u;
}
void MsgHead::clear_has_checksum() {
  _has_bits_[0] &= ~0x00000008u;
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_sbody;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_additional;
        break;
      }
...
// optional string sbody = 2;
bool MsgBody::has_sbody() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void MsgBody::set_has_sbody() {
  _has_bits_[0] |= 0x00000002u;
}
void MsgBody::clear_has_sbody() {
  _has_bits_[0] &= ~0x00000002u;
}
