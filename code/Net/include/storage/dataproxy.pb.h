...
class MemOperate_MongoOperateDefaultTypeInternal;
...
template<> ::DataMem::MemOperate_MongoOperate* Arena::CreateMaybeMessage<::DataMem::MemOperate_MongoOperate>(Arena*);
...
enum MemOperate_MongoOperate_E_QUERY_TYPE {
...
bool MemOperate_MongoOperate_E_QUERY_TYPE_IsValid(int value);
const MemOperate_MongoOperate_E_QUERY_TYPE MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_MIN = MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_UNKNONW;
const MemOperate_MongoOperate_E_QUERY_TYPE MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_MAX = MemOperate_MongoOperate_E_QUERY_TYPE_CUSTOM;
const int MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_ARRAYSIZE = MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_MAX + 1;

const ::google::protobuf::EnumDescriptor* MemOperate_MongoOperate_E_QUERY_TYPE_descriptor();
inline const ::std::string& MemOperate_MongoOperate_E_QUERY_TYPE_Name(MemOperate_MongoOperate_E_QUERY_TYPE value) {
  return ::google::protobuf::internal::NameOfEnum(
    MemOperate_MongoOperate_E_QUERY_TYPE_descriptor(), value);
}
inline bool MemOperate_MongoOperate_E_QUERY_TYPE_Parse(
    const ::std::string& name, MemOperate_MongoOperate_E_QUERY_TYPE* value) {
  return ::google::protobuf::internal::ParseNamedEnum<MemOperate_MongoOperate_E_QUERY_TYPE>(
    MemOperate_MongoOperate_E_QUERY_TYPE_descriptor(), name, value);
}
...
class MemOperate_RedisOperate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:DataMem.MemOperate.RedisOperate) */ {
 public:
  ...
  void clear_raw_cmds();
  static const int kRawCmdsFieldNumber = 10;
  const ::std::string& raw_cmds(int index) const;
  ::std::string* mutable_raw_cmds(int index);
  void set_raw_cmds(int index, const ::std::string& value);
  #if LANG_CXX11
  void set_raw_cmds(int index, ::std::string&& value);
  #endif
  void set_raw_cmds(int index, const char* value);
  void set_raw_cmds(int index, const void* value, size_t size);
  ::std::string* add_raw_cmds();
  void add_raw_cmds(const ::std::string& value);
  #if LANG_CXX11
  void add_raw_cmds(::std::string&& value);
  #endif
  void add_raw_cmds(const char* value);
  void add_raw_cmds(const void* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& raw_cmds() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_raw_cmds();
...
class MemOperate_MongoOperate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:DataMem.MemOperate.MongoOperate) */ {
 public:
  MemOperate_MongoOperate();
  virtual ~MemOperate_MongoOperate();

  MemOperate_MongoOperate(const MemOperate_MongoOperate& from);
  ...
  #if LANG_CXX11
  MemOperate_MongoOperate(MemOperate_MongoOperate&& from) noexcept
    : MemOperate_MongoOperate() {
    *this = ::std::move(from);
  }
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const MemOperate_MongoOperate* internal_default_instance() {
  ...
  void Swap(MemOperate_MongoOperate* other);
  friend void swap(MemOperate_MongoOperate& a, MemOperate_MongoOperate& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline MemOperate_MongoOperate* New() const final {
    return CreateMaybeMessage<MemOperate_MongoOperate>(NULL);
  }

  MemOperate_MongoOperate* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<MemOperate_MongoOperate>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const MemOperate_MongoOperate& from);
  void MergeFrom(const MemOperate_MongoOperate& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MemOperate_MongoOperate* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef MemOperate_MongoOperate_E_QUERY_TYPE E_QUERY_TYPE;
  static const E_QUERY_TYPE E_QUERY_TYPE_UNKNONW =
    MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_UNKNONW;
  static const E_QUERY_TYPE SELECT =
    MemOperate_MongoOperate_E_QUERY_TYPE_SELECT;
  static const E_QUERY_TYPE INSERT =
    MemOperate_MongoOperate_E_QUERY_TYPE_INSERT;
  static const E_QUERY_TYPE UPDATE =
    MemOperate_MongoOperate_E_QUERY_TYPE_UPDATE;
  static const E_QUERY_TYPE UPSERT =
    MemOperate_MongoOperate_E_QUERY_TYPE_UPSERT;
  static const E_QUERY_TYPE DELETE =
    MemOperate_MongoOperate_E_QUERY_TYPE_DELETE;
  static const E_QUERY_TYPE CUSTOM =
    MemOperate_MongoOperate_E_QUERY_TYPE_CUSTOM;
  static inline bool E_QUERY_TYPE_IsValid(int value) {
    return MemOperate_MongoOperate_E_QUERY_TYPE_IsValid(value);
  }
  static const E_QUERY_TYPE E_QUERY_TYPE_MIN =
    MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_MIN;
  static const E_QUERY_TYPE E_QUERY_TYPE_MAX =
    MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_MAX;
  static const int E_QUERY_TYPE_ARRAYSIZE =
    MemOperate_MongoOperate_E_QUERY_TYPE_E_QUERY_TYPE_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  E_QUERY_TYPE_descriptor() {
  ...
  int raw_cmds_size() const;
  void clear_raw_cmds();
  static const int kRawCmdsFieldNumber = 12;
  const ::std::string& raw_cmds(int index) const;
  ::std::string* mutable_raw_cmds(int index);
  void set_raw_cmds(int index, const ::std::string& value);
  #if LANG_CXX11
  ...
  static const int kBatchSizeFieldNumber = 10;
  ...
  bool has_mod_factor() const;
  void clear_mod_factor();
  static const int kModFactorFieldNumber = 11;
  ::google::protobuf::uint64 mod_factor() const;
  void set_mod_factor(::google::protobuf::uint64 value);
...
class MemOperate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:DataMem.MemOperate) */ {
 public:
  ...
  typedef MemOperate_MongoOperate MongoOperate;
  ...
  static const int kMongoOperateFieldNumber = 4;
  private:
  ...
  ::DataMem::MemOperate_MongoOperate* release_mongo_operate();
  ::DataMem::MemOperate_MongoOperate* mutable_mongo_operate();
  void set_allocated_mongo_operate(::DataMem::MemOperate_MongoOperate* mongo_operate);
 ...
 private:
  ...
  void set_has_mongo_operate();
  void clear_has_mongo_operate();
  ...
  ::DataMem::MemOperate_MongoOperate* mongo_operate_;
...
inline const ::std::string& MemOperate_RedisOperate::raw_cmds(int index) const {
  ...
  return raw_cmds_.Get(index);
}
inline ::std::string* MemOperate_RedisOperate::mutable_raw_cmds(int index) {
  // @@protoc_insertion_point(field_mutable:DataMem.MemOperate.RedisOperate.raw_cmds)
  return raw_cmds_.Mutable(index);
}
inline void MemOperate_RedisOperate::set_raw_cmds(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:DataMem.MemOperate.RedisOperate.raw_cmds)
  raw_cmds_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void MemOperate_RedisOperate::set_raw_cmds(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:DataMem.MemOperate.RedisOperate.raw_cmds)
  raw_cmds_.Mutable(index)->assign(std::move(value));
}
#endif
inline void MemOperate_RedisOperate::set_raw_cmds(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  raw_cmds_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.RedisOperate.raw_cmds)
}
inline void MemOperate_RedisOperate::set_raw_cmds(int index, const void* value, size_t size) {
  raw_cmds_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.RedisOperate.raw_cmds)
}
inline ::std::string* MemOperate_RedisOperate::add_raw_cmds() {
  // @@protoc_insertion_point(field_add_mutable:DataMem.MemOperate.RedisOperate.raw_cmds)
  return raw_cmds_.Add();
}
inline void MemOperate_RedisOperate::add_raw_cmds(const ::std::string& value) {
  raw_cmds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:DataMem.MemOperate.RedisOperate.raw_cmds)
}
#if LANG_CXX11
inline void MemOperate_RedisOperate::add_raw_cmds(::std::string&& value) {
  raw_cmds_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:DataMem.MemOperate.RedisOperate.raw_cmds)
}
#endif
inline void MemOperate_RedisOperate::add_raw_cmds(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  raw_cmds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:DataMem.MemOperate.RedisOperate.raw_cmds)
}
inline void MemOperate_RedisOperate::add_raw_cmds(const void* value, size_t size) {
  raw_cmds_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:DataMem.MemOperate.RedisOperate.raw_cmds)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
MemOperate_RedisOperate::raw_cmds() const {
  // @@protoc_insertion_point(field_list:DataMem.MemOperate.RedisOperate.raw_cmds)
  return raw_cmds_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
MemOperate_RedisOperate::mutable_raw_cmds() {
...
inline void MemOperate_MongoOperate::set_has_query_type() {
  _has_bits_[0] |= 0x00000020u;
}
inline void MemOperate_MongoOperate::clear_has_query_type() {
  _has_bits_[0] &= ~0x00000020u;
}
...
inline ::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE MemOperate_MongoOperate::query_type() const {
  ...
  return static_cast< ::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE >(query_type_);
}
inline void MemOperate_MongoOperate::set_query_type(::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE value) {
  assert(::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE_IsValid(value));
  set_has_query_type();
  query_type_ = value;
...
inline void MemOperate_MongoOperate::set_has_table_name() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MemOperate_MongoOperate::clear_has_table_name() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void MemOperate_MongoOperate::set_table_name(const ::std::string& value) {
  set_has_table_name();
  table_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:DataMem.MemOperate.MongoOperate.table_name)
}
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_table_name(::std::string&& value) {
  set_has_table_name();
  table_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DataMem.MemOperate.MongoOperate.table_name)
}
#endif
inline void MemOperate_MongoOperate::set_table_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_table_name();
  table_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.table_name)
}
inline void MemOperate_MongoOperate::set_table_name(const char* value, size_t size) {
  set_has_table_name();
  table_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.table_name)
}
inline ::std::string* MemOperate_MongoOperate::mutable_table_name() {
  set_has_table_name();
  // @@protoc_insertion_point(field_mutable:DataMem.MemOperate.MongoOperate.table_name)
  return table_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MemOperate_MongoOperate::release_table_name() {
...
inline void MemOperate_MongoOperate::set_allocated_table_name(::std::string* table_name) {
  if (table_name != NULL) {
    set_has_table_name();
  } else {
    clear_has_table_name();
...
inline void MemOperate_MongoOperate::set_has_cond() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MemOperate_MongoOperate::clear_has_cond() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline void MemOperate_MongoOperate::set_cond(const ::std::string& value) {
  set_has_cond();
...
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_cond(::std::string&& value) {
  set_has_cond();
  cond_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DataMem.MemOperate.MongoOperate.cond)
}
#endif
inline void MemOperate_MongoOperate::set_cond(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_cond();
  cond_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.cond)
}
inline void MemOperate_MongoOperate::set_cond(const char* value, size_t size) {
  set_has_cond();
  cond_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.cond)
}
inline ::std::string* MemOperate_MongoOperate::mutable_cond() {
  set_has_cond();
...
inline ::std::string* MemOperate_MongoOperate::release_cond() {
  // @@protoc_insertion_point(field_release:DataMem.MemOperate.MongoOperate.cond)
  if (!has_cond()) {
    return NULL;
  }
  clear_has_cond();
  return cond_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MemOperate_MongoOperate::set_allocated_cond(::std::string* cond) {
  if (cond != NULL) {
    set_has_cond();
  } else {
    clear_has_cond();
...
inline void MemOperate_MongoOperate::set_has_val() {
  _has_bits_[0] |= 0x00000004u;
}
inline void MemOperate_MongoOperate::clear_has_val() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline void MemOperate_MongoOperate::set_val(const ::std::string& value) {
  set_has_val();
...
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_val(::std::string&& value) {
  set_has_val();
  val_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DataMem.MemOperate.MongoOperate.val)
}
#endif
inline void MemOperate_MongoOperate::set_val(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_val();
  val_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.val)
}
inline void MemOperate_MongoOperate::set_val(const char* value, size_t size) {
  set_has_val();
  val_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.val)
}
inline ::std::string* MemOperate_MongoOperate::mutable_val() {
  set_has_val();
...
inline ::std::string* MemOperate_MongoOperate::release_val() {
...
inline void MemOperate_MongoOperate::set_allocated_val(::std::string* val) {
  if (val != NULL) {
    set_has_val();
  } else {
    clear_has_val();
...
inline void MemOperate_MongoOperate::set_has_fields() {
  _has_bits_[0] |= 0x00000008u;
}
inline void MemOperate_MongoOperate::clear_has_fields() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline void MemOperate_MongoOperate::set_fields(const ::std::string& value) {
  set_has_fields();
...
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_fields(::std::string&& value) {
  set_has_fields();
  fields_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DataMem.MemOperate.MongoOperate.fields)
}
#endif
inline void MemOperate_MongoOperate::set_fields(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_fields();
  fields_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.fields)
}
inline void MemOperate_MongoOperate::set_fields(const char* value, size_t size) {
  set_has_fields();
  fields_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.fields)
}
inline ::std::string* MemOperate_MongoOperate::mutable_fields() {
  set_has_fields();
...
inline ::std::string* MemOperate_MongoOperate::release_fields() {
  // @@protoc_insertion_point(field_release:DataMem.MemOperate.MongoOperate.fields)
  if (!has_fields()) {
    return NULL;
  }
  clear_has_fields();
  return fields_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MemOperate_MongoOperate::set_allocated_fields(::std::string* fields) {
  if (fields != NULL) {
    set_has_fields();
  } else {
    clear_has_fields();
...
inline void MemOperate_MongoOperate::set_has_sort() {
  _has_bits_[0] |= 0x00000010u;
}
inline void MemOperate_MongoOperate::clear_has_sort() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline void MemOperate_MongoOperate::set_sort(const ::std::string& value) {
  set_has_sort();
...
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_sort(::std::string&& value) {
  set_has_sort();
  sort_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DataMem.MemOperate.MongoOperate.sort)
}
#endif
inline void MemOperate_MongoOperate::set_sort(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_sort();
  sort_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.sort)
}
inline void MemOperate_MongoOperate::set_sort(const char* value, size_t size) {
  set_has_sort();
  sort_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.sort)
}
inline ::std::string* MemOperate_MongoOperate::mutable_sort() {
  set_has_sort();
...
inline ::std::string* MemOperate_MongoOperate::release_sort() {
  // @@protoc_insertion_point(field_release:DataMem.MemOperate.MongoOperate.sort)
  if (!has_sort()) {
    return NULL;
  }
  clear_has_sort();
  return sort_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MemOperate_MongoOperate::set_allocated_sort(::std::string* sort) {
  if (sort != NULL) {
    set_has_sort();
  } else {
    clear_has_sort();
...
inline void MemOperate_MongoOperate::set_has_limit() {
  _has_bits_[0] |= 0x00000040u;
}
inline void MemOperate_MongoOperate::clear_has_limit() {
  _has_bits_[0] &= ~0x00000040u;
}
...
inline ::google::protobuf::uint32 MemOperate_MongoOperate::limit() const {
  // @@protoc_insertion_point(field_get:DataMem.MemOperate.MongoOperate.limit)
  return limit_;
}
inline void MemOperate_MongoOperate::set_limit(::google::protobuf::uint32 value) {
  set_has_limit();
  limit_ = value;
...
inline void MemOperate_MongoOperate::set_has_limit_from() {
  _has_bits_[0] |= 0x00000080u;
}
inline void MemOperate_MongoOperate::clear_has_limit_from() {
  _has_bits_[0] &= ~0x00000080u;
}
...
inline ::google::protobuf::uint32 MemOperate_MongoOperate::limit_from() const {
  // @@protoc_insertion_point(field_get:DataMem.MemOperate.MongoOperate.limit_from)
  return limit_from_;
}
inline void MemOperate_MongoOperate::set_limit_from(::google::protobuf::uint32 value) {
  set_has_limit_from();
  limit_from_ = value;
...
inline void MemOperate_MongoOperate::set_has_batch_size() {
  _has_bits_[0] |= 0x00000100u;
}
inline void MemOperate_MongoOperate::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000100u;
}
...
inline ::google::protobuf::uint32 MemOperate_MongoOperate::batch_size() const {
  // @@protoc_insertion_point(field_get:DataMem.MemOperate.MongoOperate.batch_size)
  return batch_size_;
}
inline void MemOperate_MongoOperate::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
...
inline void MemOperate_MongoOperate::set_has_mod_factor() {
  _has_bits_[0] |= 0x00000200u;
}
inline void MemOperate_MongoOperate::clear_has_mod_factor() {
  _has_bits_[0] &= ~0x00000200u;
}
...
inline ::google::protobuf::uint64 MemOperate_MongoOperate::mod_factor() const {
  // @@protoc_insertion_point(field_get:DataMem.MemOperate.MongoOperate.mod_factor)
  return mod_factor_;
}
inline void MemOperate_MongoOperate::set_mod_factor(::google::protobuf::uint64 value) {
  set_has_mod_factor();
  mod_factor_ = value;
...
inline ::std::string* MemOperate_MongoOperate::mutable_raw_cmds(int index) {
  // @@protoc_insertion_point(field_mutable:DataMem.MemOperate.MongoOperate.raw_cmds)
  return raw_cmds_.Mutable(index);
}
inline void MemOperate_MongoOperate::set_raw_cmds(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:DataMem.MemOperate.MongoOperate.raw_cmds)
  raw_cmds_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void MemOperate_MongoOperate::set_raw_cmds(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:DataMem.MemOperate.MongoOperate.raw_cmds)
  raw_cmds_.Mutable(index)->assign(std::move(value));
}
#endif
inline void MemOperate_MongoOperate::set_raw_cmds(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  raw_cmds_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:DataMem.MemOperate.MongoOperate.raw_cmds)
}
inline void MemOperate_MongoOperate::set_raw_cmds(int index, const void* value, size_t size) {
  raw_cmds_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:DataMem.MemOperate.MongoOperate.raw_cmds)
}
inline ::std::string* MemOperate_MongoOperate::add_raw_cmds() {
  // @@protoc_insertion_point(field_add_mutable:DataMem.MemOperate.MongoOperate.raw_cmds)
  return raw_cmds_.Add();
}
inline void MemOperate_MongoOperate::add_raw_cmds(const ::std::string& value) {
  raw_cmds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:DataMem.MemOperate.MongoOperate.raw_cmds)
}
#if LANG_CXX11
inline void MemOperate_MongoOperate::add_raw_cmds(::std::string&& value) {
  raw_cmds_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:DataMem.MemOperate.MongoOperate.raw_cmds)
}
#endif
inline void MemOperate_MongoOperate::add_raw_cmds(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  raw_cmds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:DataMem.MemOperate.MongoOperate.raw_cmds)
}
inline void MemOperate_MongoOperate::add_raw_cmds(const void* value, size_t size) {
  raw_cmds_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:DataMem.MemOperate.MongoOperate.raw_cmds)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
MemOperate_MongoOperate::raw_cmds() const {
  // @@protoc_insertion_point(field_list:DataMem.MemOperate.MongoOperate.raw_cmds)
  return raw_cmds_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
MemOperate_MongoOperate::mutable_raw_cmds() {
...
inline void MemOperate::set_has_mongo_operate() {
  _has_bits_[0] |= 0x00000004u;
}
inline void MemOperate::clear_has_mongo_operate() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void MemOperate::clear_mongo_operate() {
  if (mongo_operate_ != NULL) mongo_operate_->Clear();
  clear_has_mongo_operate();
}
inline const ::DataMem::MemOperate_MongoOperate& MemOperate::_internal_mongo_operate() const {
  return *mongo_operate_;
}
inline const ::DataMem::MemOperate_MongoOperate& MemOperate::mongo_operate() const {
  const ::DataMem::MemOperate_MongoOperate* p = mongo_operate_;
  // @@protoc_insertion_point(field_get:DataMem.MemOperate.mongo_operate)
  return p != NULL ? *p : *reinterpret_cast<const ::DataMem::MemOperate_MongoOperate*>(
      &::DataMem::_MemOperate_MongoOperate_default_instance_);
}
inline ::DataMem::MemOperate_MongoOperate* MemOperate::release_mongo_operate() {
  // @@protoc_insertion_point(field_release:DataMem.MemOperate.mongo_operate)
  clear_has_mongo_operate();
  ::DataMem::MemOperate_MongoOperate* temp = mongo_operate_;
  mongo_operate_ = NULL;
  return temp;
}
inline ::DataMem::MemOperate_MongoOperate* MemOperate::mutable_mongo_operate() {
  set_has_mongo_operate();
  if (mongo_operate_ == NULL) {
    auto* p = CreateMaybeMessage<::DataMem::MemOperate_MongoOperate>(GetArenaNoVirtual());
    mongo_operate_ = p;
  }
  // @@protoc_insertion_point(field_mutable:DataMem.MemOperate.mongo_operate)
  return mongo_operate_;
}
inline void MemOperate::set_allocated_mongo_operate(::DataMem::MemOperate_MongoOperate* mongo_operate) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete mongo_operate_;
  }
  if (mongo_operate) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      mongo_operate = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, mongo_operate, submessage_arena);
    }
    set_has_mongo_operate();
  } else {
    clear_has_mongo_operate();
  }
  mongo_operate_ = mongo_operate;
...
template <> struct is_proto_enum< ::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::DataMem::MemOperate_MongoOperate_E_QUERY_TYPE>() {
