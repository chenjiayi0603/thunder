 ...
 * Modify history:
 ******************************************************************************/
#ifndef SRC_CODEC_CODECWSEXTENTPB_APP_HPP_
#define SRC_CODEC_CODECWSEXTENTPB_APP_HPP_
#include <string>
#include <map>
...
/**
 * @brief CodecWebSocketJson websocket编码解码器，pb消息体
 * @note 可以解析 http请求以及websocket请求
 */
class CodecWebSocketPbApp: public ThunderCodec
{
public:
    CodecWebSocketPbApp(util::E_CODEC_TYPE eCodecType, const std::string& strKey = "That's a lizard.");
    virtual ~CodecWebSocketPbApp();
    /**
...
private:
    ...
    E_CODEC_STATUS DecodeHandShake(tagConnectionAttr* pConn,MsgHead& oMsgHead, MsgBody& oMsgBody);
private:
    /**
   	 * @brief 解析http请求
   	 */
