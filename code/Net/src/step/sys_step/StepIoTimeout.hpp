...
public:
    ...
    virtual ~StepIoTimeout() = default;
    virtual E_CMD_STATUS Emit(int iErrno = 0,const std::string& strErrMsg = "",const std::string& strErrShow = "");
    virtual E_CMD_STATUS Callback(const tagMsgShell& stMsgShell,const MsgHead& oInMsgHead,const MsgBody& oInMsgBody,void* data = nullptr);
    virtual E_CMD_STATUS Timeout();

    E_CMD_STATUS SendHeartBeat();
private:
