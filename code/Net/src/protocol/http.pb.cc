...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 18, -1, sizeof(::HttpMsg_Header)},
  { 25, -1, sizeof(::HttpMsg_Upgrade)},
  { 32, -1, sizeof(::HttpMsg)},
};
...
HttpMsg::HttpMsg(const HttpMsg& from)
  ...
  ::memcpy(&type_, &from.type_,
    static_cast<size_t>(reinterpret_cast<char*>(&keep_alive_) -
    reinterpret_cast<char*>(&type_)) + sizeof(keep_alive_));
...
void HttpMsg::SharedCtor() {
  ...
  ::memset(&upgrade_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&keep_alive_) -
      reinterpret_cast<char*>(&upgrade_)) + sizeof(keep_alive_));
}
...
void HttpMsg::SerializeWithCachedSizes(
  ...
  if (this->has_upgrade()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      16, this->_internal_upgrade(), output);
  }

  // float keep_alive = 17;
  if (this->keep_alive() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(17, this->keep_alive(), output);
  }
  ...
  if (this->has_upgrade()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        16, this->_internal_upgrade(), deterministic, target);
  }

  // float keep_alive = 17;
  if (this->keep_alive() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(17, this->keep_alive(), target);
  }
