...
class Election : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:coor.Election) */ {
 public:
  ...
  static const int kBeleadertimeFieldNumber = 5;
  ::google::protobuf::uint64 beleadertime() const;
  void set_beleadertime(::google::protobuf::uint64 value);
 ...
 private:
  ...
  ::google::protobuf::uint64 beleadertime_;
...
inline void Election::clear_beleadertime() {
  beleadertime_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 Election::beleadertime() const {
  // @@protoc_insertion_point(field_get:coor.Election.beleadertime)
  return beleadertime_;
}
inline void Election::set_beleadertime(::google::protobuf::uint64 value) {
