...
struct RaftAppendEntriesGlobalsTypeInternal;
extern RaftAppendEntriesGlobalsTypeInternal _RaftAppendEntries_globals_;
extern const ::google::protobuf::internal::ClassDataFull RaftAppendEntries_class_data_;
class RaftAppendEntriesRsp;
struct RaftAppendEntriesRspGlobalsTypeInternal;
extern RaftAppendEntriesRspGlobalsTypeInternal _RaftAppendEntriesRsp_globals_;
extern const ::google::protobuf::internal::ClassDataFull RaftAppendEntriesRsp_class_data_;
class RaftOnlineNodeEntry;
struct RaftOnlineNodeEntryGlobalsTypeInternal;
extern RaftOnlineNodeEntryGlobalsTypeInternal _RaftOnlineNodeEntry_globals_;
extern const ::google::protobuf::internal::ClassDataFull RaftOnlineNodeEntry_class_data_;
class RaftRequestVote;
struct RaftRequestVoteGlobalsTypeInternal;
extern RaftRequestVoteGlobalsTypeInternal _RaftRequestVote_globals_;
extern const ::google::protobuf::internal::ClassDataFull RaftRequestVote_class_data_;
class RaftRequestVoteRsp;
struct RaftRequestVoteRspGlobalsTypeInternal;
extern RaftRequestVoteRspGlobalsTypeInternal _RaftRequestVoteRsp_globals_;
...
/* @@protoc_insertion_point(class_definition:coor.RaftRequestVoteRsp) */ {
 public:
  ...
  [[nodiscard]] static const RaftRequestVoteRsp& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<RaftRequestVoteRsp>(
        &_RaftRequestVoteRsp_globals_);
  }
...
/* @@protoc_insertion_point(class_definition:coor.RaftRequestVote) */ {
 public:
  ...
  [[nodiscard]] static const RaftRequestVote& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<RaftRequestVote>(
        &_RaftRequestVote_globals_);
  }
...
/* @@protoc_insertion_point(class_definition:coor.RaftOnlineNodeEntry) */ {
 public:
  ...
  [[nodiscard]] static const RaftOnlineNodeEntry& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<RaftOnlineNodeEntry>(
        &_RaftOnlineNodeEntry_globals_);
  }
...
/* @@protoc_insertion_point(class_definition:coor.RaftAppendEntriesRsp) */ {
 public:
  ...
  [[nodiscard]] static const RaftAppendEntriesRsp& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<RaftAppendEntriesRsp>(
        &_RaftAppendEntriesRsp_globals_);
  }
...
/* @@protoc_insertion_point(class_definition:coor.RaftAppendEntries) */ {
 public:
  ...
  [[nodiscard]] static const RaftAppendEntries& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<RaftAppendEntries>(
        &_RaftAppendEntries_globals_);
  }
