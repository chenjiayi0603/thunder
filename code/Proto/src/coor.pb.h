...
namespace coor {
class Election;
struct ElectionGlobalsTypeInternal;
extern ElectionGlobalsTypeInternal _Election_globals_;
...
/* @@protoc_insertion_point(class_definition:coor.Election) */ {
 public:
  ...
  [[nodiscard]] static const Election& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::default_instance<Election>(
        &_Election_globals_);
  }
...
inline void Election::add_added_node_id(::uint32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_added_node_id()
...
inline void Election::add_removed_node_id(::uint32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_removed_node_id()
      ->InternalAddWithArena<const ::google::protobuf::MessageLite*>(
          internal_visibility(), this, value);
