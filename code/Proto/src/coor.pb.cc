...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::coor::Election, beleadertime_),
};
...
const int Election::kBeleadertimeFieldNumber;
...
Election::Election(const Election& from)
  ...
  ::memcpy(&is_leader_, &from.is_leader_,
    static_cast<size_t>(reinterpret_cast<char*>(&beleadertime_) -
    reinterpret_cast<char*>(&is_leader_)) + sizeof(beleadertime_));
  // @@protoc_insertion_point(copy_constructor:coor.Election)
}

void Election::SharedCtor() {
  ::memset(&is_leader_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&beleadertime_) -
      reinterpret_cast<char*>(&is_leader_)) + sizeof(beleadertime_));
}
...
void Election::SerializeWithCachedSizes(
  ...
  // uint64 beleadertime = 5;
  if (this->beleadertime() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(5, this->beleadertime(), output);
  }
...
::google::protobuf::uint8* Election::InternalSerializeWithCachedSizesToArray(
  ...
  // uint64 beleadertime = 5;
  if (this->beleadertime() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(5, this->beleadertime(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:coor.Election)
  ...
  if (from.beleadertime() != 0) {
    set_beleadertime(from.beleadertime());
  }
}
...
void Election::InternalSwap(Election* other) {
  ...
  swap(beleadertime_, other->beleadertime_);
