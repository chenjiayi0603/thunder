 ...
 * */
void FindNearSphereGeoJsonCond(double longitude,double latitude,int dis,loss::CJsonObject &mongocfindCond)
{
    loss::CJsonObject coordinate;
    {
        //$nearSphere
        loss::CJsonObject nearSphere;
        {
            //$geometry
            loss::CJsonObject geometry;
 ...
 * */
void FindNearSphereCond(double longitude,double latitude,int dis,loss::CJsonObject &mongocfindCond)
{
    //$nearSphere
    loss::CJsonObject coordinates;
    {
