...
bool LbsProxySession::GetUserCoordinateInfo(unsigned int user_id,loss::CJsonObject &userObj)
{
    /*
...
bool LbsProxySession::GetGroupCoordinateInfo(unsigned int group_id,loss::CJsonObject &groupObj)
{
    /*
