...
StepHttpRequestState::StepHttpRequestState(const oss::tagMsgShell& stMsgShell,const HttpMsg& oInHttpMsg)
{
...
oss::E_CMD_STATUS StepHttpRequestState::State0()
{
...
oss::E_CMD_STATUS StepHttpRequestState::State1()
{
	LOG4CPLUS_DEBUG_FMT(GetLogger(), "%s last state:%u uiTestVal:%u ResHttpMsg:%s",
			__FUNCTION__,GetLastState(),++m_uiTestVal,m_oResHttpMsg.DebugString().c_str());
...
oss::E_CMD_STATUS StepHttpRequestState::State2()
{
	LOG4CPLUS_DEBUG_FMT(GetLogger(), "%s last state:%u uiTestVal:%u ResHttpMsg:%s",
				__FUNCTION__,GetLastState(),++m_uiTestVal,m_oResHttpMsg.DebugString().c_str());
...
oss::E_CMD_STATUS StepHttpRequestState::State3()
{
	LOG4CPLUS_DEBUG_FMT(GetLogger(), "%s last state:%u uiTestVal:%u ResHttpMsg:%s",
				__FUNCTION__,GetLastState(),++m_uiTestVal,m_oResHttpMsg.DebugString().c_str());
...
oss::E_CMD_STATUS StepHttpRequestState::State4()
{
	LOG4CPLUS_DEBUG_FMT(GetLogger(), "%s last state:%u uiTestVal:%u ResHttpMsg:%s",
				__FUNCTION__,GetLastState(),++m_uiTestVal,m_oResHttpMsg.DebugString().c_str());
	LOG4CPLUS_DEBUG_FMT(GetLogger(),"StepState done");
