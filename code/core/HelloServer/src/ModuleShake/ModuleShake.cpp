...
oss::Cmd* create()
{
    oss::Cmd* pCmd = new starshiplib::ModuleShake();
    return(pCmd);
}
#ifdef __cplusplus
}
...
bool ModuleShake::ResponseWebsocketResponseHandshake(const oss::tagMsgShell& stMsgShell,const ws_req_t &ws_req,
                const HttpMsg& oInHttpMsg)
{
...
bool ModuleShake::ResponseHttp(const oss::tagMsgShell& stMsgShell, const HttpMsg& oInHttpMsg,
