...
class ModuleShake: public oss::Module
{
public:
    ModuleShake();
    virtual ~ModuleShake();
...
private:
    bool ResponseWebsocketResponseHandshake(const oss::tagMsgShell& stMsgShell,const ws_req_t &ws_req,
                        const HttpMsg& oHttpMsg);
    bool ResponseHttp(const oss::tagMsgShell& stMsgShell, const HttpMsg& oInHttpMsg,
