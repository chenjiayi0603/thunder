...
oss::Cmd* create()
{
    oss::Cmd* pCmd = new starshiplib::CmdNodeReport();
    return (pCmd);
}
...
bool CmdNodeReport::AnyMessage(const oss::tagMsgShell& stMsgShell,
...
bool CmdNodeReport::Response(const oss::tagMsgShell& stMsgShell,
