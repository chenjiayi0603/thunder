...
oss::Cmd* create()
{
    oss::Cmd* pCmd = new starshiplib::CmdGetLoadMinServer();
    return (pCmd);
}
...
bool CmdGetLoadMinServer::AnyMessage(const oss::tagMsgShell& stMsgShell,
...
bool CmdGetLoadMinServer::Response(const oss::tagMsgShell& stMsgShell,
