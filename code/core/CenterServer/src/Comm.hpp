...
typedef oss::int8 int8;
typedef oss::int16 int16;
typedef oss::int32 int32;
typedef oss::int64 int64;
...
typedef struct NodeLogInfo
{
    ...
    void Debug(const log4cplus::Logger &logger)
    {
        LOG4CPLUS_DEBUG_FMT(logger,"nodeId(%d),nodeType(%s),nodeInnerPort(%d),nodeInnerIp(%s),nodeAccessPort(%d),nodeAccessIp(%s),"
