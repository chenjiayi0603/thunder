...
class RedisStorageStep: public RedisStep
{
public:
    RedisStorageStep(Step* pNextStep = NULL);
    RedisStorageStep(const tagMsgShell& stReqMsgShell, const MsgHead& oReqMsgHead, const MsgBody& oReqMsgBody, Step* pNextStep = NULL);
