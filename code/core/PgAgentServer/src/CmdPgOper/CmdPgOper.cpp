...
extern "C" {
    ...
    oss::Cmd* create()
    {
        oss::Cmd* pCmd = new oss::CmdPgOper();
        return(pCmd);
    }
#ifdef __cplusplus
}
...
bool CmdPgOper::AnyMessage(const oss::tagMsgShell& stMsgShell, const MsgHead& oInMsgHead, const MsgBody& oInMsgBody)
{
...
bool CmdPgOper::GetDbConnection(const oss::tagMsgShell& stMsgShell, const MsgHead& oInMsgHead,const DataMem::MemOperate& oQuery,
...
bool CmdPgOper::FetchOrEstablishConnection(const oss::tagMsgShell& stMsgShell, const MsgHead& oInMsgHead,
				DataMem::MemOperate::DbOperate::E_QUERY_TYPE eQueryType,
                const std::string& strMasterIdentify, const std::string& strSlaveIdentify,
                const loss::CJsonObject& oInstanceConf, pqxx::connection** ppMasterDbi, pqxx::connection** ppSlaveDbi)
{
...
int CmdPgOper::ConnectDb(const loss::CJsonObject& oInstanceConf, pqxx::connection* &pPgConn,const std::string& strDbIdentify)
{
...
int CmdPgOper::ConnectDb(const loss::tagDbConfDetail &stDbConfDetail, pqxx::connection* &pPgConn)
{
    LOG4_DEBUG("%s()", __FUNCTION__);
    LOG4_DEBUG("InitDbConn(%s, %s, %s, %s, %u, %s)", stDbConfDetail.m_stDbConnInfo.m_szDbHost,
                    stDbConfDetail.m_stDbConnInfo.m_szDbUser, stDbConfDetail.m_stDbConnInfo.m_szDbPwd,
...
int CmdPgOper::SyncQuery(const oss::tagMsgShell& stMsgShell,const MsgHead& oInMsgHead,const DataMem::MemOperate& oQuery, pqxx::connection* pPgConn)
{
    LOG4_TRACE("%s()", __FUNCTION__);
    if (NULL == pPgConn)
    {
...
void CmdPgOper::Response(const oss::tagMsgShell &stMsgShell,const MsgHead &oInMsgHead,int iErrno, const std::string& strErrMsg)
{
...
bool CmdPgOper::Response(const oss::tagMsgShell &stMsgShell,const MsgHead &oInMsgHead,const DataMem::MemRsp& oRsp)
{
