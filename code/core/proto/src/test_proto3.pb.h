...
class test_bar : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:server.test_bar) */ {
 public:
  ...
  inline test_bar* New() const { return New(NULL); }

  test_bar* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  static test_bar* default_instance_;
};
// -------------------------------------------------------------------
...
class test_proto3 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:server.test_proto3) */ {
 public:
  ...
  inline test_proto3* New() const { return New(NULL); }

  test_proto3* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static test_proto3* default_instance_;
};
// ===================================================================
