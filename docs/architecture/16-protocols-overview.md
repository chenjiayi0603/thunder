...
详见 `docs/architecture/15-https-codec.md`（完整运维指南）。
...
**相关文档**：
- `docs/architecture/15-https-codec.md` — HTTPS 完整运维指南（含证书、部署、排障）

---

## 附录：性能基准数据

> 原独立文档 `architecture/16-protocols-overview.md#附录性能基准数据`，合并于此方便查阅。
