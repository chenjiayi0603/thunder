...
| 机制 | 文件 | 行号 |
|------|------|------|
| 异步 Lease 补领 | [EtcdCenterConnector.cpp:261](code/Net/src/labor/EtcdCenterConnector.cpp:261) | AsyncLeaseGrant |
| 注册延续链 | [EtcdCenterConnector.cpp:425](code/Net/src/labor/EtcdCenterConnector.cpp:425) | DoRegister |
| 槽位抢占 | [EtcdCenterConnector.cpp:405](code/Net/src/labor/EtcdCenterConnector.cpp:405) | AsyncTryClaimSlot |
| KeepAlive 定时器 | [EtcdCenterConnector.cpp:660](code/Net/src/labor/EtcdCenterConnector.cpp:660) | OnKeepAliveTimer |
| m_regInProgress 超时 | [EtcdCenterConnector.cpp:427](code/Net/src/labor/EtcdCenterConnector.cpp:427) | 30s 防死锁 |
